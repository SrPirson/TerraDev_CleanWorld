...
export default function NavBar() {
	  ...
	  <>
		<nav className="flex bg-brand-primary text-white font-bold p-4 h-20 items-center">
			...
			<button><Link to="/map?report=true" className="p-2 rounded-xl bg-brand-light text-brand-dark font-bold transition-colors hover:bg-white">+ Reportar</Link></button>
		</nav>
	  </>
	);
}